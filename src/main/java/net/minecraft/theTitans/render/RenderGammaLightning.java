...
@OnlyIn(Dist.CLIENT)
public class RenderGammaLightning extends EntityRenderer<EntityGammaLightning> {
    public RenderGammaLightning(EntityRendererManager p_i46157_1_) {
        super(p_i46157_1_);
    }
    ...
    public void render(EntityGammaLightning entity, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
        ...
        float c0 = entity.getRed();
        float c1 = entity.getGreen();
        float c2 = entity.getBlue();
        ...
        for (int j = 0; j < 4; ++j) {
            ...
            for (int k = 0; k < 3; ++k) {
                ...
                for (int j1 = l; j1 >= i1; --j1) {
                    ...
                    quad(matrix4f, ivertexbuilder, f2, f3, j1, f4, f5, c0, c1, c2, f10, f11, false, false, true, false);
                    quad(matrix4f, ivertexbuilder, f2, f3, j1, f4, f5, c0, c1, c2, f10, f11, true, false, true, true);
                    quad(matrix4f, ivertexbuilder, f2, f3, j1, f4, f5, c0, c1, c2, f10, f11, true, true, false, true);
                    quad(matrix4f, ivertexbuilder, f2, f3, j1, f4, f5, c0, c1, c2, f10, f11, false, true, false, false);
                }
            }
        }
    ...
    public ResourceLocation getTextureLocation(EntityGammaLightning p_110775_1_) {
