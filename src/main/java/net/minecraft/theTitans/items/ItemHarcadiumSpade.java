...
public class ItemHarcadiumSpade extends ItemTitanSpade {
    public ItemHarcadiumSpade(IItemTier p_i48460_1_) {
        super(p_i48460_1_);
    }
    ...
    public boolean hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (target != null && (target.getBbHeight() >= 6.0f || target instanceof EntityTitan || !target.isOnGround())) {
            target.hurt(DamageSourceExtra.causeAntiTitanDamage(attacker), 350.0f);
