...
public class EntityZombieTitan extends EntityTitan implements IAnimatedEntity, IEntityMultiPartTitan {
    ...
    public void aiStep() {
        ...
        if (this.tickCount > 5) {
            ...
            this.rightFore.moveTo(this.getX() + f3 * (this.isBaby() ? 3.0 : 6.0), this.getY() + (this.isBaby() ? 10.0 : 20.0), this.getZ() + f2 * (this.isBaby() ? 3.0 : 12.0), 0.0f, 0.0f);
            this.leftFore.moveTo(this.getX() - f3 * (this.isBaby() ? 3.0 : 6.0), this.getY() + (this.isBaby() ? 10.0 : 20.0), this.getZ() - f2 * (this.isBaby() ? 3.0 : 12.0), 0.0f, 0.0f);
            
			this.rightLeg.moveTo(this.getX() + f3 * (this.isBaby() ? 1.0 : 4.0), this.getY(), this.getZ() + f2 * (this.isBaby() ? 1.0 : 2.0), 0.0f, 0.0f);
            this.leftLeg.moveTo(this.getX() - f3 * (this.isBaby() ? 1.0 : 4.0), this.getY(), this.getZ() - f2 * (this.isBaby() ? 1.0 : 2.0), 0.0f, 0.0f);
            this.rightCalf.moveTo(this.getX() + f3 * (this.isBaby() ? 1.0 : 4.0), this.getY(), this.getZ() + f2 * (this.isBaby() ? 1.0 : 2.0), 0.0f, 0.0f);
            this.leftCalf.moveTo(this.getX() - f3 * (this.isBaby() ? 1.0 : 4.0), this.getY(), this.getZ() - f2 * (this.isBaby() ? 1.0 : 2.0), 0.0f, 0.0f);
