...
public class EntityZombieTitan extends EntityTitan implements IAnimatedEntity, IEntityMultiPartTitan {
    ...
    public void aiStep() {
        ...
        if (this.tickCount > 5) {
            ...
            this.rightFore.moveTo(this.rightArm.getX(), this.rightArm.getY(), this.rightArm.getZ() + f2 * (this.isBaby() ? 3.0 : 12.0), 0.0f, 0.0f);
            this.leftFore.moveTo(this.leftArm.getX(), this.leftArm.getY(), this.leftArm.getZ() - f2 * (this.isBaby() ? 3.0 : 12.0), 0.0f, 0.0f);
