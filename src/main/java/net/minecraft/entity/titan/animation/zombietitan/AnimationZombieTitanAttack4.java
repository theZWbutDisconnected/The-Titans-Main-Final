...
public class AnimationZombieTitanAttack4 extends AIAnimation {
    ...
    public AnimationZombieTitanAttack4(final EntityZombieTitan test) {
        super(test);
        this.entity = test;
    }
    ...
    public void updateTask() {
        if (this.entity.getAnimTick() < 80 && this.entity.getTarget() != null) {
        ...
        if (this.entity.getAnimTick() >= 106 && this.entity.getAnimTick() <= 110) {
            final double d8 = this.entity.isArmed() ? 28.0 : 6.0;
            ...
            this.entity.collideWithEntities(this.entity.body, this.entity.level.getEntities(this.entity, this.entity.body.getBoundingBox().inflate(24.0, 8.0, 24.0)));
            final List list11 = this.entity.level.getEntities(this.entity, this.entity.getBoundingBox().inflate(14.0, 1.0, 14.0).move(dx, 0.0, dz));
