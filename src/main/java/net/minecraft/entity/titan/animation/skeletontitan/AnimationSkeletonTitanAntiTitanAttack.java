...
public class AnimationSkeletonTitanAntiTitanAttack extends AIAnimation {
    ...
    public AnimationSkeletonTitanAntiTitanAttack(final EntitySkeletonTitan test) {
        super(test);
        this.entity = test;
    }
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 12 && this.entity.getTarget() != null) {
            ...
            this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.getBoundingBox().inflate(48.0, 48.0, 48.0)));
            ...
            if (this.entity.isArmored()) {
                ...
                this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(26.0, 26.0, 26.0)));
            }
            ...
            if (list11 != null && !list11.isEmpty()) {
                for (int i2 = 0; i2 < list11.size(); ++i2) {
                    ...
                    if (this.entity.canAttack(entity1.getClass())) {
                        ...
                        this.entity.attackChoosenEntity(entity1, f, i);
                        this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(16.0, 16.0, 16.0)));
                        this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(16.0, 16.0, 16.0)));
                        this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(16.0, 16.0, 16.0)));
                        this.entity.collideWithEntities(this.entity.pelvis, this.entity.level.getEntities(this.entity, this.entity.pelvis.getBoundingBox().inflate(16.0, 16.0, 16.0)));
                    }
